...
def generate_launch_description():
    ...
    yolo_args = {
        ...
        "half":           LaunchConfiguration("half",       default="False"),  # Set "True" if you have FP16 support on GPU
    ...
    rviz_node = Node(
        ...
        name="rviz2",
        output="screen",
        arguments=["-d", '/home/commu/Desktop/yolo_ros/src/yolo_ros/yolo_bringup/launch/yolo_3d.rviz']
    )
